...
<link rel="shortcut icon" href="assets/img/icons/dollar (2).png" />
    ...
    <title>سودآور | خرجی ها | حمل و نقل</title>
...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">داشبورد / خرجی ها /</span> حمل و نقل
</h4>
...
<a class="btn btn-primary" href="add-hamlonaghl.php"><i class="bx bx-plus"></i>افزودن خرجی</a>
<br /> <br />
  ...
  <table id="table" class="table table-striped">
    ...
    <?php
      $query = $conn->query("SELECT * FROM `hamlonaghl`") or die(mysqli_error());
  ...
  <a class="btn btn-label-secondary mt-3" href="dashboards-daily.php"> بازگشت </a>
</div> </div>
</div> </div>
<br /> <br />
<!--/ table -->
  ...
  <div class="modal-dialog modal-dialog-centered modal-simple modal-add-new-cc">
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        ...
        <form action="hamlonaghl.php" method="post" enctype="multipart/form-data" class="row g-3">
