    ...
    <div class="col app-calendar-sidebar" id="app-calendar-sidebar">
      ...
      <div class="p-4">
        ...
        <div class="form-check mb-2">
          ...
          <label class="form-check-label" for="selectAll">نمایش همه</label>
        </div>

        <div class="app-calendar-events-filter">
          <div class="form-check form-check-success mb-2">
            <input class="form-check-input input-filter" type="checkbox" id="select-personal" data-value="personal" checked>
            <label class="form-check-label" for="select-personal">درآمد</label>
          </div>

          <div class="form-check form-check-danger mb-2">
            <input class="form-check-input input-filter" type="checkbox" id="select-holiday" data-value="holiday" checked>
            <label class="form-check-label" for="select-holiday">خرجی ها</label>
          </div>

          <div class="form-check form-check-warning mb-2">
            <input class="form-check-input input-filter" type="checkbox" id="select-family" data-value="family" checked>
            <label class="form-check-label" for="select-family">قبوض</label>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col app-calendar-content">
      ...
      <div class="offcanvas offcanvas-end event-sidebar" tabindex="-1" id="addEventSidebar" aria-labelledby="addEventSidebarLabel">
        <div class="offcanvas-header border-bottom">
          <h5 class="offcanvas-title mb-2" id="addEventSidebarLabel">افزودن رویداد</h5>
        ...
        <div class="offcanvas-body">
          <form class="event-form pt-0" id="eventForm" onsubmit="return false">
            ...
            <div class="mb-3">
              <label class="form-label" for="eventLabel">نوع رویداد</label>
              <select class="select2 select-event-label form-select" id="eventLabel" name="eventLabel">
                <option data-label="success" value="Personal">درآمد</option>
                <option data-label="danger" value="Family">خرجی ها</option>
                <option data-label="warning" value="Holiday">قبوض</option>
              </select>
            </div>

            <div class="mb-3">
              <label class="form-label" for="eventStartDate">شروع رویداد</label>
              <input type="text" class="form-control" id="eventStartDate" name="eventStartDate" placeholder="تاریخ شروع رویداد" />
            </div>

            <div class="mb-3">
              <label class="form-label" for="eventEndDate">پایان رویداد</label>
              <input type="text" class="form-control" id="eventEndDate" name="eventEndDate" placeholder="تاریخ پایان رویداد" />
            </div>
            ...
            <div class="mb-3">
              <label class="switch">
                ...
                <span class="switch-label">همه روزها</span>
              </label>
            </div>
