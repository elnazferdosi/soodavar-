...
<link rel="shortcut icon" href="assets/img/icons/dollar (2).png" />
    ...
    <title>سودآور | فراموشی رمز عبور</title>
      ...
      <g id="Icon" transform="translate(27.000000, 15.000000)">
        ...
        <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
          ...
          <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-5"></use>
            ...
            <span class="app-brand-text demo demo text-body fw-bolder">soodavar</span>
          </a>
        </div>
        <!-- /Logo -->
        <h4 class="mb-2">رمز عبور خود را فراموش کرده اید؟ 🔒</h4>
        <p class="mb-4">ایمیل خود را وارد کنید تا لینک بازیابی رمز عبور ارسال شود</p>
        <form id="formAuthentication" class="mb-3" action="reset-password.php" method="POST">
          <div class="mb-3">
            <label for="email" class="form-label">ایمیل</label>
            <input type="text" class="form-control" id="email" name="email" placeholder="ایمیل خود را وارد کنید" autofocus>
          </div>
          <button class="btn btn-primary d-grid w-100" href="">ارسال لینک بازیابی</button>
        </form>
