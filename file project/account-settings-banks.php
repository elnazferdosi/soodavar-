...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
      ...
      <span class="app-brand-text demo menu-text fw-bolder ms-2">soodavar</span>
    </a>
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card mb-4">
      <h5 class="card-header">افزودن حساب بانکی</h5>
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <form id="creditCardForm" class="row g-3" onsubmit="return false">
              ...
              <div class="col-12 col-md-6">
                <label class="form-label" for="paymentName">نام صاحب کارت</label>
                <input type="text" id="paymentName" class="form-control" />
              </div>
              <div class="col-6 col-md-3">
                <label class="form-label" for="paymentExpiryDate">تاریخ انقضا</label>
                <input type="text" id="paymentExpiryDate" class="form-control expiry-date-mask" placeholder="ماه/سال" />
              </div>
              <div class="col-6 col-md-3">
                <label class="form-label" for="paymentCvv">CVV2</label>
                <div class="input-group input-group-merge">
                  <input type="text" id="paymentCvv" class="form-control cvv-code-mask" maxlength="4" />
                  <span class="input-group-text cursor-pointer" id="paymentCvv2"><i class="bx bx-help-circle text-muted" data-bs-toggle="tooltip" data-bs-placement="top"></i></span>
                </div>
              </div>
            ...
            <div class="added-cards">
              <div class="cardMaster bg-lighter rounded-2 p-3 mb-3">
                <div class="d-flex justify-content-between flex-sm-row flex-column">
                  <div class="card-information me-2">
                    <img
                    src="assets/img/icons/payments/sepah.png"
                    alt="sepah"
                    height="24"
                    class="me-2"
                    >
                    <div class="d-flex align-items-center mb-1 flex-wrap gap-2">
                      <h6 class="mb-0 me-2">نازنین احمدی</h6>
                      <span class="badge bg-label-primary">حساب اصلی</span>
                    </div>
                    <span class="card-number">5892 1010 8933 2980</span>
                  </div>
                  <div class="d-flex flex-column text-start text-sm-end">
                    <div class="d-flex order-sm-0 order-1 mt-sm-0 mt-3">
                      <button class="btn btn-label-primary me-2" data-bs-toggle="modal" data-bs-target="#editCCModal">ویرایش</button>
                      <button class="btn btn-label-secondary">حذف</button>
                    </div>
                    <small class="mt-sm-auto mt-2 order-sm-1 order-0">انقضا کارت : 02/12</small>
                  </div>
                </div>
              </div>
              <div class="cardMaster bg-lighter rounded-2 p-3">
                <div class="d-flex justify-content-between flex-sm-row flex-column">
                  <div class="card-information me-2">
                    <img
                    src="assets/img/icons/payments/meli.png"
                    alt="ملی"
                    height="24"
                    class="me-2"
                    >
                    <h6 class="mb-1">نازنین احمدی</h6>
                    <span class="card-number">6037 9974 4870 0147</span>
                  </div>
                  <div class="d-flex flex-column text-start text-sm-end">
                    <div class="d-flex order-sm-0 order-1 mt-sm-0 mt-3">
                      <button class="btn btn-label-primary me-2" data-bs-toggle="modal" data-bs-target="#editCCModal">ویرایش</button>
                    ...
                    <small class="mt-sm-auto mt-2 order-sm-1 order-0">انقضا کارت : 02/03</small>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="modal-body">
        ...
        <form id="editCCForm" class="row g-3" onsubmit="return false">
          <div class="col-12">
            ...
            <div class="input-group input-group-merge">
              <input id="modalEditCard" name="modalEditCard" class="form-control credit-card-mask-edit" type="text" value="2980 8933 1010 5892" aria-describedby="modalEditCard2" />
              <span class="input-group-text cursor-pointer p-1" id="modalEditCard2"><span class="card-type-edit"></span></span>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <label class="form-label" for="modalEditName">نام صاحب کارت</label>
            <input type="text" id="modalEditName" class="form-control" value="نازنین احمدی" />
          </div>
          <div class="col-6 col-md-3">
            <label class="form-label" for="modalEditExpiryDate">تاریخ انقضا</label>
            <input type="text" id="modalEditExpiryDate" class="form-control expiry-date-mask-edit" placeholder="ماه/سال" value="02/12" />
          </div>
          <div class="col-6 col-md-3">
            <label class="form-label" for="modalEditCvv">CVV2</label>
            <div class="input-group input-group-merge">
              <input type="text" id="modalEditCvv" class="form-control cvv-code-mask-edit" maxlength="4" value="310" />
          ...
          <div class="col-12">
            <label class="switch">
              ...
              <span class="switch-label">حساب اصلی</span>
            </label>
          </div>
          <div class="col-12 text-center">
            <button type="submit" class="btn btn-primary me-sm-3 me-1 mt-3">تایید</button>
