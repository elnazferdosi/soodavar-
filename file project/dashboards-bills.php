...
<div class="offcanvas offcanvas-end" id="add-new-record">
  <div class="offcanvas-header border-bottom">
    <h5 class="offcanvas-title" id="exampleModalLabel">افزودن قبوض</h5>
  ...
  <div class="offcanvas-body flex-grow-1">
    <form class="add-new-record pt-0 row g-2" id="form-add-new-record" onsubmit="return false">
      ...
      <div class="col-sm-12">
        ...
        <div class="input-group input-group-merge">
          <select id="basicType_bill" class="form-control dt-type_bill , select2 form-select" name="basicType_bill">
            <option value="">نوع قبض را انتخاب کنید</option>
            <option value="wather">آب</option>
            <option value="power">برق</option>
      ...
      <div class="col-sm-12">
        <label class="form-label" for="basicDate">تاریخ پرداخت قبض</label>
        <div class="input-group input-group-merge">
      ...
      <div class="col-sm-12">
        <label class="form-label" for="basicSalary">مبلغ قابل پرداخت قبض</label>
        <div class="input-group input-group-merge">
...
<script src="assets/vendor/libs/formvalidation/dist/js/plugins/AutoFocus.min.js"></script>
  ...
  <!-- Page JS -->
  <script src="assets/js/dashboards-bills.js"></script>
