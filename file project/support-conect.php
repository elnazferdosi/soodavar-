...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <!-- / Menu -->
    ...
    <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <!-- Content -->
              <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card mb-5">
                  <h4 class="card-header">راه های ارتباطی با سودآور</h4>
                  <p> </p>
                  <div class="d-flex mb-5">
                    <div class="flex-shrink-0">
                      <div class="icon_margin">
                      <img src="assets/img/icons/brands/whatsapp.png" alt="whatsapp" class="me-4" height="40">
                    </div>
                    </div>
                    <div class="flex-grow-1 row">
                      <div class="col-8 col-sm-7 mb-sm-0 mb-2">
                        <h6 class="mb-0">شماره تماس و واتساپ</h6>
                        <p> </p>
                        <label>09140384635</label>
                      </div>
        </div>
      </div>
      ...
      <div class="d-flex mb-5">
        <div class="flex-shrink-0">
          <div class="icon_margin_gmail">
          <img src="assets/img/icons/brands/gmail.png" alt="gmail" class="me-4" height="40">
        </div>
        </div>
        <div class="flex-grow-1 row">
          <div class="col-8 col-sm-7 mb-sm-0 mb-2">
              <h6 class="mb-0">ایمیل پشتیبانی</h6>
            <p> </p>
            <a href="https://soodavar@gmail.com" target="_blank">soodavar@gmail.com</a>
          </div>
        </div>
      </div>
...
<div class="d-flex mb-5">
  <div class="flex-shrink-0">
    <div class="icon_margin_instagram">
    <img src="assets/img/icons/brands/instagram.png" alt="instagram" class="me-4" height="40">
  </div>
  </div>
  <div class="flex-grow-1 row">
    <div class="col-8 col-sm-7 mb-sm-0 mb-2">
      <h6 class="mb-0">پیج اینستاگرام</h6>
      <p> </p>
      <a href="https://www.instagram.com/soodavar_402/" target="_blank">soodavar_402@</a>
    </div>
  </div>
  </div>
</div>
