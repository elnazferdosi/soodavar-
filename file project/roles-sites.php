...
<link rel="shortcut icon" href="assets/img/icons/dollar (2).png" />
    ...
    <title>سودآور | قوانین سایت</title>
      ...
      <div class="content-wrapper">
        ...
        <!-- Content -->
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-5">
              <h4 class="card-header">قوانین و شرایط سودآور</h4>
              <p> </p>
              <div class="d-flex mb-5">
                <div class="flex-shrink-0">
                  <div class="icon_margin">
                 <img src="assets/img/icons/terms.png" alt="terms" class="me-4" height="40">
               </div>
                </div>
                <div class="flex-grow-1 row">
                  <div>
                    <p class="mb-0"> ما در سودآور تلاش میکنیم تا اطلاعات همه کاربران محرمانه باقی بماند. تمامی کاربران آزادی عمل دارند تا جایی که آسیبی به هیچ جا! وارد نشود هر کاری در سودآور انجام دهند! با این حال تیم سودآور این اختیار را دارد که هر حساب کاربری را در هر زمانی مسدود یا محدود کند. در صورت هر نوع سوء استفاده از هر قسمت از بخش های سودآور، حساب کاربری کاربر ممکن است مسدود و یا محدود شود</p>
                  </div>
            </div>
            </div>
            </div>
