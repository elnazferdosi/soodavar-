      ...
      <div class="content-wrapper">
        ...
        <!-- Content -->
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-5">
              <h4 class="card-header">درباره سودآور</h4>
              <p> </p>
              <div class="d-flex mb-5">
                <div class="flex-shrink-0">
                  <div class="icon_margin">
                 <img src="assets/img/icons/info.png" alt="info" class="me-4" height="40">
               </div>
                </div>
                <div class="flex-grow-1 row">
                    <p class="mb-0">سودآور یک سرویس حسابداری ساده، رایگان و در حال توسعه است. این سرویس برای محاسبه هزینه ها و درآمدهای شخصی و شرکت های کوچک بسیار کاربردی است

.ما در سودآور تمامی پیشنهادات را بررسی میکنیم تا به تدریج بتوانیم تمامی نیازهای حسابداری شما را مرتفع نماییم</p>
              </div>
              </div>
            </div>
