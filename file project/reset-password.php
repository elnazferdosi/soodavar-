...
<link rel="shortcut icon" href="assets/img/icons/dollar (2).png" />
    ...
    <title>سودآور | بازیابی رمز عبور</title>
  ...
  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
      <g id="Icon" transform="translate(27.000000, 15.000000)">
        ...
        <p class="mb-4">ارسال شده برای <span class="fw-bold"><a href=""></a></span></p>
        <form id="formAuthentication" class="mb-3" action="login.php" method="POST">
          ...
          <div class="mb-3 form-password-toggle">
            <label class="form-label" for="confirm-password">تکرار رمز عبور جدید</label>
            <div class="input-group input-group-merge">
