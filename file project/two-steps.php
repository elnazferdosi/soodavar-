...
<link rel="shortcut icon" href="assets/img/icons/dollar (2).png" />
    ...
    <title>سودآور | احراز هویت دومرحله ای</title>
  ...
  <div class="authentication-inner row m-0">
    ...
    <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
      <div class="w-100 d-flex justify-content-center">
        <img src="assets/img/illustrations/girl-verify-password-light.png" class="img-fluid" alt="Login image" width="600" data-app-dark-img="illustrations/girl-verify-password-dark.png" data-app-light-img="illustrations/girl-verify-password-light.png">
  ...
  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
      <g id="Icon" transform="translate(27.000000, 15.000000)">
        ...
        <h4 class="mb-2">احراز هویت دومرحله ای 💬</h4>
        <p class="text-start mb-4">
          یک کد امنیتی به ایمیل زیر ارسال شد
        ...
        <form id="twoStepsForm" action="index.php" method="POST">
          ...
          <div class="text-center">کد امنیتی را دریافت نکردید؟
