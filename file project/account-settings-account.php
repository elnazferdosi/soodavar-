...
<link rel="shortcut icon" href="assets/img/icons/dollar (2).png" />
    ...
    <title>سودآور | حساب کاربری</title>
...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-md-row mb-3">
      <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class="bx bx-user me-1"></i> حساب کاربری </a></li>
    ...
    <div class="card mb-4">
      <h5 class="card-header">پروفایل</h5>
      <!-- Account -->
      <div class="card-body">
        <div class="d-flex align-items-start align-items-sm-center gap-4">
          ...
          <div class="button-wrapper">
            ...
            <button type="button" class="btn btn-label-secondary account-image-reset mb-4">
              ...
              <span class="d-none d-sm-block">بازگردانی</span>
            </button>

            <p class="text-muted mb-0">نوع فایل مجاز:JPG,PNG,GIF  حداکثر سایز مجاز: 800 کیلوبایت</p>
          </div>
        </div>
      </div>
      <hr class="my-0">
        ...
        <form id="formAccountSettings" method="POST" onsubmit="return false">
          <div class="row">
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control" type="text" id="firstName" name="firstName" placeholder="نام" autofocus />
            </div>
            <div class="mb-3 col-md-6">
              <label for="lastName" class="form-label">نام خانوادگی</label>
              <input class="form-control" type="text" name="lastName" id="lastName" placeholder="نام خانوادگی" />
            </div>
            <div class="mb-3 col-md-6">
              <label for="email" class="form-label">ایمیل</label>
              <input class="form-control" type="text" id="email" name="email" placeholder="soodavar@gmail.com" />
            </div>
            <div class="mb-3 col-md-6">
              <label for="organization" class="form-label">شغل</label>
              <input type="text" class="form-control" id="organization" name="organization" placeholder="شغل" />
            </div>
            <div class="mb-3 col-md-6">
              <label class="form-label" for="phoneNumber">شماره موبایل</label>
              <div class="input-group input-group-merge">
                <span class="input-group-text">ایران (98+)</span>
                <input type="text" id="phoneNumber" name="phoneNumber" class="form-control" placeholder="4567 123 912" />
              </div>
            </div>
            <div class="mb-3 col-md-6">
            ...
            <div class="mb-3 col-md-6">
              ...
              <select id="country" class="select2 form-select">
                <option value="">کشور موردنظر خود را انتخاب کنید</option>
                <option value="Australia">استرالیا</optio>
                <option value="Brazil">آفریقا</option>
                <option value="Canada">آلمان</option>
                <option value="China">آمریکا</option>
                <option value="France">اندونزی</option>
                <option value="Germany">ایتالیا</option>
                <option value="India">ایران</option>
                <option value="Indonesia">ترکیه</option>
                <option value="Italy">روسیه</option>
                <option value="Japan">ژاپن</option>
                <option value="Korea">چین</option>
                <option value="Korea">فرانسه</option>
                <option value="Russia">کره</option>
              </select>
            </div>
            <div class="mb-3 col-md-6">
              <label for="language" class="form-label">زبان</label>
              <select id="language" class="select2 form-select">
                <option value="">زبان موردنظر خود را انتخاب کنید</option>
                <option value="en">آلمانی</option>
                <option value="fr">انگلیسی</option>
                <option value="de">فارسی</option>
                <option value="pt">فرانسوی</option>
              </select>
            </div>
          <div class="mt-2">
      ...
      <div class="card-body">
        <div class="mb-3 col-12 mb-0">
          <div class="alert alert-warning">
            <h6 class="alert-heading fw-bold mb-1">آیا میخواهید حساب کاربری خود را حذف کنید؟</h6>
            <p class="mb-0">در صورت حذف حساب کاربری قادر به بازگردانی آن نخواهید بود. لطفا مطمین باشید.</p>
          </div>
        </div>
        <form id="formAccountDeactivation" onsubmit="return false">
          <div class="form-check mb-3">
            <input class="form-check-input" type="checkbox" name="accountActivation" id="accountActivation" />
            <label class="form-check-label" for="accountActivation">حساب کاربری خود را حذف میکنم.</label>
          </div>
          <button type="submit" class="btn btn-danger deactivate-account">حذف حساب کابری</button>
        </form>
      </div>
    </div>
  </div>
