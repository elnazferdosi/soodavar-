...
<link rel="shortcut icon" href="assets/img/icons/dollar (2).png" />
    ...
    <title>سودآور | حساب های فعال با ایمیل</title>
            ...
            <div class="row">
              <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                  ...
                  <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class="bx bx-link-alt me-1"></i> حساب های فعال با ایمیل </a></li>
                </ul>

    <div class="row">
      <div class="col-md-6 col-12 mb-md-0 mb-4">
        <div class="card">
          <h5 class="card-header">پلتفرم های فعال</h5>
          <div class="card-body">
            <p>پلتفرم های فعال با ایمیل واردشده در حساب کاربری</p>
            <!-- Connections -->
            <div class="d-flex mb-3">
              ...
              <div class="flex-grow-1 row">
                <div class="col-9 mb-sm-0 mb-2">
                  ...
                  <small class="text-muted">تقویم و مخاطبان</small>
                </div>
            ...
            <div class="d-flex mb-3">
              ...
              <div class="flex-grow-1 row">
                <div class="col-9 mb-sm-0 mb-2">
                  ...
                  <small class="text-muted">مدیریت Repositori های ایجادشده روی ایمیل در Github</small>
                </div>
                <div class="col-3 text-end">
                  <label class="switch me-0">
                    <input type="checkbox" class="switch-input" checked />
      ...
      <div class="col-md-6 col-12">
        <div class="card">
          ...
          <div class="card-body">
            <p>شبکه های اجتماعی فعال با ایمیل واردشده در حساب کاربری</p>
            <!-- Social Accounts -->
            <div class="d-flex mb-3">
              <div class="flex-shrink-0">
              ...
              <div class="flex-grow-1 row">
                <div class="col-8 col-sm-7 mb-sm-0 mb-2">
                  ...
                  <small class="text-muted">متصل نیستید</small>
                </div>
            ...
            <div class="d-flex mb-3">
              ...
              <div class="flex-grow-1 row">
                <div class="col-8 col-sm-7 mb-sm-0 mb-2">
                  ...
                  <a href="https://twitter.com/nazaninahmadi" target="_blank">@nazaninahmadi</a>
                </div>
                <div class="col-4 col-sm-5 text-end">
            ...
            <div class="d-flex mb-3">
              ...
              <div class="flex-grow-1 row">
                <div class="col-8 col-sm-7 mb-sm-0 mb-2">
                  ...
                  <a href="https://www.instagram.com/n_ahmadi79/" target="_blank">@n_ahmadi79</a>
                </div>
                <div class="col-4 col-sm-5 text-end">
                  <button type="button" class="btn btn-icon btn-label-danger">
                    <i class='bx bx-trash-alt'></i>
