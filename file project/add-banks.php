...
<link rel="shortcut icon" href="assets/img/icons/dollar (2).png" />
    ...
    <title>سودآور | افزودن حساب بانکی</title>
...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">تنظیمات حساب کاربری / حساب های بانکی /</span>
    افزودن حساب بانکی
</h4>
    ...
    <form method = "POST" action="banks.php">
      <div class = "form-group">
        <div class="text_idb margin-title">
          ...
          <input type = "text" class = "form-control" name = "numbers" maxlength="16" placeholder="****-****-****-****" required = "required" />
        </div>
      </div>
      <br />
      ...
      <div class = "form-group">
        <div class="text_idb margin_record">
          ...
          <input type = "text" class = "form-control" name = "owners" required = "required" />
        </div>
      </div>
      <br />
      ...
      <div class = "form-group">
        <div class="text_idb margin_record">
          ...
          <input type = "text" class = "form-control" name = "exp" placeholder="ماه/سال" required = "required" />
        </div>
      </div>
      <br />
      ...
      <div class = "form-group">
        <div class="text_idb margin_record">
          <label>CVV2</label>
          <input type = "text" class = "form-control" name = "cvv" maxlength="4" required = "required" />
        </div>
      </div>
      <br />
      ...
      <div class ="form-group">
        <div class="text_idb margin_record">
          <label>به عنوان حساب اصلی انتخاب شود؟</label>
          <br />
          <input type="radio" name="primarys" value="حساب اصلی" required="required" />بله  
          <input type="radio" name="primarys" value="" required="required" />خیر 
        </div>
      </div>
      <br />
      ...
      <br />
        ...
        <a class="btn btn-danger size-btn" href="banks.php"> <i class="bx bx-error"> </i>  انصراف</a>
