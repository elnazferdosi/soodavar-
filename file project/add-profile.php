...
<link rel="shortcut icon" href="assets/img/icons/dollar (2).png" />
    ...
    <title>سودآور | افزودن پروفایل کاربری</title>
...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">تنظیمات حساب کاربری / پروفایل کاربری /</span>
...
<div class = "form_profile">
    <form method = "POST" action="profile-account.php">
      <div class = "form-group">
        <div class="text_idb margin-title">
          <label>نام</label>
          <input type = "text" class = "form-control" name = "first" placeholder="نام" required = "required" />
        </div>
      </div>
      <br />
      ...
      <div class = "form-group">
        <div class="text_idb margin_record">
          ...
          <input type = "text" class = "form-control" name = "last" placeholder="نام خانوادگی" required = "required" />
        </div>
      </div>
      <br />
      ...
      <div class = "form-group">
        <div class="text_idb margin_record">
          <label>شغل</label>
          <input type = "text" class = "form-control" name = "job" placeholder="شغل" required = "required" />
        </div>
      </div>
      <br />
      ...
      <div class = "form-group">
        <div class="text_idb margin_record">
          ...
          <input type = "text" class = "form-control" name = "numbers" placeholder="4567 123 0912" required = "required" />
        </div>
      </div>
      <br />
      ...
      <div class = "form-group">
        <div class="text_idb margin_record">
          <label>آدرس</label>
          <input type = "text" class = "form-control" name = "address" placeholder="استان-شهر" required = "required" />
        </div>
      </div>
      <br />
      ...
      <br />
        ...
        <a class="btn btn-danger size-btn" href="profile-account.php"> <i class="bx bx-error"> </i>  انصراف</a>
