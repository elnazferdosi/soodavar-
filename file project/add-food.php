...
<link rel="shortcut icon" href="assets/img/icons/dollar (2).png" />
    ...
    <title>سودآور | افزودن خرجی (مواد غذایی)</title>
...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">داشبورد / خرجی ها /</span> افزودن خرجی (مواد غذایی)
</h4>
...
<div class = "form_daily">
    <form method = "POST" action="food.php">
      ...
      <br />
        ...
        <a class="btn btn-danger size-btn" href="food.php"> <i class="bx bx-error"> </i>  انصراف</a>
