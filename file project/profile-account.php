...
<link rel="shortcut icon" href="assets/img/icons/dollar (2).png" />
    ...
    <title>سودآور | پروفایل کاربری</title>
...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-md-row mb-3">
      <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class="bx bx-user me-1"></i> پروفایل کاربری </a></li>
...
<div class="table-responsive">
  <a class="btn btn-primary" href="add-profile.php"><i class="bx bx-plus"></i>افزودن پروفایل</a>
  <br /> <br />
  <table id="table" class="table table-striped">
    <thead>
      <tr class="th_style_profile">
        <th>ردیف</th>
        <th>نام</th>
        <th>نام خانوادگی</th>
        <th>ایمیل</th>
    ...
    <?php
      $query = $conn->query("SELECT * FROM `profiles`") or die(mysqli_error());
      $query1 = $conn->query("SELECT email FROM `users`") or die(mysqli_error());
    ...
    ?>
      ...
      <tr class="td_style">
        ...
        <td> <center>
          <a class="btn btn-label-primary me-2 edit" data-id="<?= $fetch['id'] ?>" data-first="<?= $fetch['first'] ?>" data-last="<?= $fetch['last'] ?>" data-job="<?= $fetch['job'] ?>" data-numbers="<?= $fetch['numbers'] ?>" data-address="<?= $fetch['address'] ?>" data-bs-toggle="modal" data-bs-target="#editprofilesModal"><i class="glyphicon glyphicon-edit"> ویرایش </i></a>
        </center> </td>
      </tr>
...
<!-- edit profile -->
<div class="modal fade" id="editprofilesModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-simple modal-add-new-cc">
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        <div class="text-center mb-4">
          <h3>ویرایش پروفایل کاربری</h3>
        </div>

        <form action="profile-account.php" method="post" enctype="multipart/form-data" class="row g-3">

          <input type="text" name="id" class="form-control" id="editID" style="display: none;" >

          <div class="col-12">
            <label class="form-label w-100 text_idb margin-title" for="first">نام</label>
            <div class="input-group input-group-merge">
              <input type="text" class="form-control" name="first" placeholder="نام" id="editFirst" required = "required" />
          </div>

          <div class="col-12 col-md-6">
            <label class="form-label text_idb margin_record" for="last">نام خانوادگی</label>
            <input type="text" class="form-control" name="last" placeholder=" نام خانوادگی" id="editLast" required = "required" />
          </div>

          <div class="col-12 col-md-6">
            <label class="form-label text_idb margin_record" for="job">شغل</label>
            <input type="text" class="form-control" name="job" placeholder="شغل" id="editJob" required = "required" />
          </div>

          <div class="col-12 col-md-6">
            <label class="form-label text_idb margin_record" for="numbers">شماره موبایل</label>
            <input type="text" class="form-control" name="numbers" placeholder="4567 123 0912" id="editNumbers" required = "required" />
          </div>

          <div class="col-12 col-md-6">
            <label class="form-label text_idb margin_record" for="address">آدرس</label>
            <input type="text" class="form-control" name="address" placeholder="استان - شهر" id="editAddress" required = "required" />
          </div>

          <div class="col-12 text-center margin_record">
            <button type="submit" class="btn btn-primary me-sm-3 me-1 mt-3" name="edit">
              <ahref="account_query.php">
              تایید
            </button>
  ...
  <script>
    ...
    editBtns.forEach(editBtn => {
      editBtn.addEventListener('click', () => {
        ...
        editFirst.value = editBtn.dataset.first
        editLast.value = editBtn.dataset.last
        editJob.value = editBtn.dataset.job
        editNumbers.value = editBtn.dataset.numbers
        editAddress.value = editBtn.dataset.address
      })
    })
  </script>
