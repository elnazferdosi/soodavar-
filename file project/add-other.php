...
<link rel="shortcut icon" href="assets/img/icons/dollar (2).png" />
    ...
    <title>سودآور | افزودن خرجی (سایر)</title>
...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">داشبورد / خرجی ها /</span> افزودن خرجی (سایر)
</h4>
...
<div class = "form_daily">
    <form method = "POST" action="other.php">
      ...
      <br />
        ...
        <a class="btn btn-danger size-btn" href="other.php"> <i class="bx bx-error"> </i>  انصراف</a>
