  ...
  <div class="col-xl-6 col-12 mb-4">
    <div class="card">
      <div class="card-header header-elements">
        <h5 class="card-title mb-0">نمودار ستونی</h5>
          <div class="card-action-element ms-auto py-0">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                <li><a href="javascript:void(0);" class="dropdown-item d-flex align-items-center">امروز</a></li>
                <li><a href="javascript:void(0);" class="dropdown-item d-flex align-items-center">دیروز</a></li>
                <li><a href="javascript:void(0);" class="dropdown-item d-flex align-items-center">یک هفته پیش</a></li>
                <li><a href="javascript:void(0);" class="dropdown-item d-flex align-items-center">یک ماه پیش</a></li>
                <li>
                <hr class="dropdown-divider">
                </li>
                <li><a href="javascript:void(0);" class="dropdown-item d-flex align-items-center">ماه جاری</a></li>
              </ul>
            </div>
          </div>
      </div>
      ...
      <div class="card-body">
        ...
        <ul class="doughnut-legend d-flex justify-content-around ps-0 mb-2 pt-1">
          ...
          <li class="ct-series-1 d-flex flex-column">
            <h5 class="mb-0 fw-bold">خرجی ها</h5>
