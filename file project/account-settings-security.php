...
<link rel="shortcut icon" href="assets/img/icons/dollar (2).png" />
    ...
    <title>سودآور | امنیت حساب کاربری</title>
...
<div class="layout-wrapper layout-content-navbar  ">
  <div class="layout-container">
        ...
        <form id="formAccountSettings" method="POST" onsubmit="return false">
          ...
          <div class="row">
            ...
            <div class="col-12 mb-4">
              <p class="fw-semibold mt-2">الزامات تعیین رمز عبور:</p>
              <ul class="ps-3 mb-0">
                <li class="mb-1">
    ...
    <div class="card mb-4">
      <h5 class="card-header">تایید دومرحله ای</h5>
      <div class="card-body">
        <p class="fw-semibold mb-3">تایید دومرحله ای بر روی شماره موبایل فعال نمی باشد</p>
        <p class="w-75">احراز هویت دو مرحله ای با نیاز به بیش از یک رمز عبور برای ورود به حساب کاربری شما، یک لایه امنیتی اضافی به حساب کاربری اضافه می کند
        </p>
        <button class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#enableOTP">فعال کردن تایید دومرحله ای</button>
      </div>
    </div>
    ...
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        ...
        <div class="text-center mb-4">
          <h3 class="mb-5">رمز عبور یکبار مصرف را فعال کنید</h3>
        </div>
        <p>شماره موبایل خود را وارد کنید، تا کد تایید برای شما ارسال شود</p>
        <form id="enableOTPForm" class="row g-3" onsubmit="return false">
          <div class="col-12">
            <label class="form-label" for="modalEnableOTPPhone">شماره موبایل</label>
            <div class="input-group input-group-merge">
              <span class="input-group-text">+98</span>
              <input type="text" id="modalEnableOTPPhone" name="modalEnableOTPPhone" class="form-control phone-number-otp-mask" placeholder="4567 123 912" />
            </div>
          </div>
          <div class="col-12">
