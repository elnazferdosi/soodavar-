...
<link rel="shortcut icon" href="assets/img/icons/dollar (2).png" />
  ...
  <body>
                      ...
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">
                            کاربر عزیز به سودآور خوش آمدید 🎉
                          </h5>
                          <p class="mb-4">
                            ما انتخاب <span class="fw-bold"> 40% </span> از کاربرانی هستیم که به دنبال سایتی آسان و کاربردی برای مدیریت مالی شخصی خود هستند.
                          </p>
                      ...
                      <div class="card">
                        <div class="card-body pb-0">
                          <div class="avatar flex-shrink-0">
                            <img
                              src="assets/img/icons/unicons/dollar-sign.png"
                              alt="Credit Card"
                              class="rounded"
                            />
                          </div>
                          <span class="d-block fw-semibold mb-1"> میانگین درآمد کلی  </span>
                          <h3 class="card-title mb-1">700 میلیون تومان</h3>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span> میانگین خرجی کلی </span>
                          <h5 class="card-title text-nowrap mb-1"> 100 میلیون تومان </h5>
                ...
                <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-8">
                        <h5 class="card-header m-0 me-2 pb-3"> نمودار درآمد سالانه </h5>
                        ...
                        >
                          <div class="d-flex">
                            ...
                            <div class="d-flex flex-column">
                              <small> میانگین درآمد این سال </small>
                              <h6 class="mb-0"> 200 میلیون تومان </h6>
                            </div>
                          </div>
                          <div class="d-flex">
                            <div class="me-2">
                            ...
                            <div class="d-flex flex-column">
                              <small> میانگین خرجی این سال </small>
                              <h6 class="mb-0"> 50 میلیون تومان </h6>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="d-block mb-1"> میانگین اجاره خانه کلی </span>
                          <h4 class="card-title text-nowrap mb-2"> 50 میلیون تومان </h4>
                        </div>
                      </div>
                    </div>
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body pb-2">
                          <span class="d-block fw-semibold mb-1"> بیشترین مبلغ قبض </span>
                          <h3 class="card-title mb-1"> 2 میلیون تومان </h3>
              ...
              <div class="row">
                          ...
                          <div class="d-flex p-4 pt-3">
                            ...
                            <div>
                              ...
                              <div class="d-flex align-items-center">
                                <h6 class="mb-0 me-1"> 100 میلیون تومان </h6>
                              </div>
                            </div>
                          </div>
                ...
                <div class="col-md-12 col-lg-6 order-4 order-lg-3">
                  <div class="card">
                    ...
                    >
                      <h5 class="card-title m-0 me-2"> یادداشت ها </h5>
                      <div class="dropdown">
                        <button
                          class="btn p-0"
                          type="button"
                    ...
                    <div class="card-body">
                      ...
                      <ul class="timeline">
                        <li class="timeline-item timeline-item-transparent">
                          ...
                          <div class="timeline-event">
                            <div class="timeline-header mb-1">
                              <h6 class="mb-0"> پرداخت قبض </h6>
                              <small class="text-muted">12 دقیقه پیش</small>
                            </div>
                            <p class="mb-2">
                              تاریخ پرداخت قبض آب 1401/12/18
                            </p>
                            <div class="d-flex">
                              <a
                                href="javascript:void(0)"
                        ...
                        <li class="timeline-item timeline-item-transparent">
                          ...
                          <div class="timeline-event">
                            <div class="timeline-header mb-1">
                              <h6 class="mb-0"> اجاره خانه </h6>
                              <small class="text-muted">45 دقیقه پیش</small>
                            </div>
                            <p class="mb-2">
                              پرداخت دو ماه اجاره عقب مانده به حساب آقای هاشمی
                            </p>
                          </div>
                        </li>
                      </ul>
                            ...
                            <table class="table table-borderless text-nowrap">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="d-flex align-items-center">
                                      <span>تعمیرات خانه و لوازم خانگی</span>
                                    </div>
                                  </td>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <div class="d-flex align-items-center">
                                  <img
                                    src="assets/img/icons/payments/melat.png"
                                    alt="melat"
                                    height="24"
                                    class="me-2"
                                  />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="d-flex align-items-center">
                                  <img
                                    src="assets/img/icons/payments/saderat.png"
                                    alt="saderat"
                                    height="24"
                                    class="me-2"
                                  />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="d-flex align-items-center">
                                  <img
                                    src="assets/img/icons/payments/tejarat.png"
                                    alt="tejarat"
                                    height="24"
                                    class="me-2"
                                  />
    ...
    <!-- Page JS -->
    <script src="assets/js/dashboards-index.js"></script>
  </body>
</html>
